...
import Clopvex_75_Clopidogrel from "./Clopvex_75_Clopidogrel";
...
const HeartCare = () => {
  ...
  if (currentView === "clopvex-detail") {
    return <Clopvex_75_Clopidogrel onBack={handleBackToGrid} />;
  }
